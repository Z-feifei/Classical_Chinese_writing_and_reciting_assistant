...
async def generate():
    try:
        ...
        UseModel.DiffofQ1 = ratings_list[0]
        UseModel.DiffofQ2 = ratings_list[1]
        UseModel.DiffofQ3 = ratings_list[2]
        UseModel.DiffofQ4 = ratings_list[3]
        UseModel.DiffofQ5 = ratings_list[4]
